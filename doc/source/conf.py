...
copyright = u'2014-2022, Peter "fracpete" Reutemann'
...
htmlhelp_basename = 'python-weka-wrapper3doc'
...
latex_documents = [
    ('index', 'python-weka-wrapper3.tex', u'python-weka-wrapper3 Documentation',
