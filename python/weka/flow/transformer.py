...
from simflow.base import Token
from simflow.transformer import Transformer
...
from weka.flow.container import ModelContainer, AttributeSelectionContainer, ClassificationContainer, \
    ClusteringContainer
...
class LoadDataset(Transformer):
    ...
    def quickinfo(self):
        ...
        return "incremental: " + str(self.config["incremental"]) \
               ...
               + ", loader: " + classes.to_commandline(self.config["custom_loader"])
...
class Train(Transformer):
    ...
    def quickinfo(self):
        ...
        :rtype: str
        """
        return "setup: " + classes.to_commandline(self.config["setup"])
...
class CrossValidate(Transformer):
    ...
    def quickinfo(self):
        ...
        :rtype: str
        """
        return "setup: " + classes.to_commandline(self.config["setup"]) + ", folds: " + str(self.config["folds"])
...
class AttributeSelection(Transformer):
    ...
    def quickinfo(self):
        ...
        :rtype: str
        """
        return "search: " + classes.to_commandline(self.config["search"]) + ", eval: " \
               + classes.to_commandline(self.config["eval"])
